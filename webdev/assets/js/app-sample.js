var config = {
  ...
  // title: "FarmSense Dashboard",
  geojson: "farmers.json",
  layerName: "Farms",
  hoverProperty: "crop_type",
  sortProperty: "lganame",
  sortOrder: "desc"
};
...
//   // geojson: "https://web.fulcrumapp.com/shares/a5c8e07368efde43.geojson",
//   // title: "FarmSense Dashboard",
//   market_geojson: "farmsense_market.json",
//   layerName: "Market",
//   hoverProperty: "market_name",
//   sortProperty: "lganame",
//   sortOrder: "desc"
// };
...
function drawCharts() {
  // Sex
  $(function() {
    var result = alasql("SELECT sex AS label, COUNT(*) AS total FROM ? GROUP BY sex", [features]);
    var columns = $.map(result, function(sex) {
      return [[sex.label, sex.total]];
    });
...
// Basemap Layers
var mapboxOSM = new L.tileLayer('http://{s}.tile.osm.org/{z}/{x}/{y}.png',{
  attribution: '&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors',
minZoom: 10,
maxZoom: 16
});

var mapboxSat = L.tileLayer('http://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}', {
...
// // Fetch the market GeoJSON file
// $.getJSON(config.market_geojson, function (market) {
//   market_geojson = market;
//   features = $.map(market_geojson.features, function(feature) {
//     return feature.properties;
    
//   });
//   featureLayer.addData(market);
//   buildConfig();
//   $("#loading-mask").hide();
// });
